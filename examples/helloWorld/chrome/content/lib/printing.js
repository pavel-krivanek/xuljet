//@line 41 '/builddir/build/BUILD/xulrunner-1.9.2.12/mozilla-1.9.2/toolkit/components/printing/content/printUtils.js'

exports.gPrintSettingsAreGlobal = false;
exports.gSavePrintSettings = false;
exports.gFocusedElement = null;

exports.gPrintFrameId = null;
...
exports.utils = {
  ...
  print: function (aWindow, modifyPrintSettingsCallback)
  {
    var webBrowserPrint = this.getWebBrowserPrint(aWindow);
    
	var printSettings = this.getPrintSettings();
	
	if (modifyPrintSettingsCallback)
	  modifyPrintSettingsCallback(printSettings)
	
    try {
      webBrowserPrint.print(printSettings, null);
      if (exports.gPrintSettingsAreGlobal && exports.gSavePrintSettings) {
        var PSSVC = Components.classes['@mozilla.org/gfx/printsettings-service;1']
                              .getService(Components.interfaces.nsIPrintSettingsService);
  ...
  // calling exports.utils.printPreview() requires that you have three functions
  ...
  getPrintSettings: function ()
  {
    ...
    if (pref) {
      exports.gPrintSettingsAreGlobal = pref.getBoolPref('print.use_global_printsettings', false);
      exports.gSavePrintSettings = pref.getBoolPref('print.save_print_settings', false);
    }
    ...
    try {
      var PSSVC = Components.classes['@mozilla.org/gfx/printsettings-service;1']
                            .getService(Components.interfaces.nsIPrintSettingsService);
      if (exports.gPrintSettingsAreGlobal) {
  ...
  _obsPP: 
  {
    observe: function(aSubject, aTopic, aData)
    {
      ...
      setTimeout(function () { exports.utils.enterPrintPreview(); }, 0);
    },
  ...
  {
    exports.gFocusedElement = document.commandDispatcher.focusedElement;
 ...
 //   navToolbox.parentNode.insertBefore(printPreviewTB, navToolbox);
    ...
    document.documentElement.setAttribute('onclose', 'exports.utils.exitPrintPreview(); return false;');
 ...
 //   getNavToolbox().parentNode.removeChild(printPreviewTB);
    ...
    if (exports.gFocusedElement)
      fm.setFocus(exports.gFocusedElement, fm.FLAG_NOSCROLL);
    else
  ...
  onKeyPressPP: function (aEvent)
  {
    ...
    if (aEvent.keyCode == aEvent.DOM_VK_ESCAPE || isModif &&
      ...
      exports.utils.exitPrintPreview();
    }
    else if (isModif) {
      var printPreviewTB = document.getElementById('print-preview-toolbar');
